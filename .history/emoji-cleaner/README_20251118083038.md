...
- Added JSON-safe cleaning (prevents corruption in package.json, config files, etc.)

- Added ignore patterns (skip folders like node_modules)

- Added custom file extensions

- Added dry-run mode

- Added detailed logs through Output Channel

- Fixed file traversal logic

- Improved emoji regex
